...
Patch113: krb5-1.10.2-gic_keytab_leak.patch
Patch114: krb5-1.11.2-kpasswd_pingpong.patch
Patch115: krb5-1.10-pkinit-null.patch
Patch116: krb5-1.10-pkinit-agility.patch
Patch117: krb5-1.10-CVE-2013-1416.patch
Patch118: krb5-fast-msg_type.patch
Patch119: krb5-1.10-gss-crossrealm.patch
Patch120: krb5-master-compatible-keys.patch
Patch121: krb5-1.11.3-client-loop.patch
Patch122: krb5-1.10-pkinit-no-prompter.patch
Patch123: krb5-1.10-pkinit-pem-prompter.patch
Patch124: krb5-bad-free.patch
Patch125: krb5-1.10-spnego-preserve-oid.patch
Patch126: krb5-1.10-system-exts.patch
Patch127: krb5-1.10.3-ksu-no-cmd.patch
Patch128: krb5-master-use_master.patch
Patch129: krb5-1.10-CVE-2014-4341_4342.patch
Patch130: krb5-1.10-CVE-2014-4341_4342-tests.patch
Patch131: krb5-CVE-2013-1418.patch
...
%patch113 -p1 -b .gic_keytab_leak
%patch114 -p1 -b .kpasswd_pingpong
%patch115 -p1 -b .pkinit-null
%patch116 -p1 -b .pkinit-agility
%patch117 -p1 -b .CVE-2013-1416
%patch118 -p1 -b .fast-msg_type
%patch119 -p1 -b .gss-crossrealm
%patch120 -p1 -b .compatible-keys
%patch121 -p1 -b .client-loop
%patch122 -p1 -b .pkinit-no-prompter
%patch123 -p1 -b .pkinit-pem-prompter
%patch124 -p1 -b .bad-free
%patch125 -p1 -b .spnego-preserve-oid
%patch126 -p1 -b .system-exts
%patch127 -p1 -b .ksu-no-cmd
%patch128 -p1 -b .use_master
%patch129 -p1 -b .CVE-2014-4341_4342
%patch130 -p1 -b .CVE-2014-4341_4342-tests
%patch131 -p1 -b .CVE-2013-1418
...
: make -C src check TMPDIR=%{_tmppath} OFFLINE=yes
...
* Wed Aug  6 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-32
- incorporate fix for MITKRB5-SA-2014-001 (CVE-2014-4345, #1128157)

* Wed Aug  6 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-31
...
* Wed Jul 30 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-30
...
* Mon Jul 28 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-29
...
* Thu Jul 24 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-28
- correct a type mistake in the backported fix for CVE-2013-1418/CVE-2013-6800

* Thu Jul 24 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-27
...
* Thu Jul 17 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-26
...
* Mon Jun 23 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-25
...
* Fri Jun 19 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-24
- define _GNU_SOURCE in files where we use EAI_NODATA, to make sure that
  it's declared (#1059730)

* Thu Jun 19 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-23
...
* Thu Jun 19 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-22
...
* Thu Jun 19 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-21
- drop patch to add additional access() checks to ksu - they shouldn't be
  resulting in any benefit

* Thu Jun 19 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-20
...
* Thu Jun 19 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-19
...
* Thu Jun 19 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-18
...
* Thu Jun 19 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-17
- backport fix to not spin on a short read when reading the length of a
  response over TCP (RT#7508, #922884)

* Thu Mar 27 2014 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-16
...
- incorporate upstream patch to fix a NULL pointer dereference when the client
  supplies an otherwise-normal-looking PKINIT request (CVE-2013-1415, #917910)
- add patch to avoid dereferencing a NULL pointer in the KDC when handling a
  draft9 PKINIT request (#917910, CVE-2012-1016)

* Tue Jun 25 2013 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-12
- pull up fix for UDP ping-pong flaw in kpasswd service (CVE-2002-2443,
  #969269)

* Tue Jun 25 2013 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-11
